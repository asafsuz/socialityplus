		...
		<div id="pageTopInner">
			...
			<nav>
				<ul>
					...
					<li><img src="imgs/send_mail.png" alt="Send an e-mail message" title="Send a mail" id="send-mail"></li>
					<li><img src="imgs/google.png" alt="Search google" title="Search google" id="search-google"></li>
					<li><img src="imgs/logout.png" alt="Logout from Socialityplus" title="Logout" id="logout"></li>
